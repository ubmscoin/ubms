...
### **1.2. 외부 코드를 차용하지 않은 순수한 개인 창작**

UBMS는 외부 코드를 차용하지 않고, 순수하게 개인 창작으로 개발되었습니다. 이는 학습 목적으로 시작된 프로젝트로, 여타 코인의 설계나 구조를 참고하더라도 이를 복사하거나 포크하지 않았다는 점에서 자부심을 가집니다.  
순수 창작 기반의 프로젝트는 초기에는 다소 어려움이 있을 수 있지만, 점진적인 개선과 외부 컨트리뷰터의 참여로 발전과 안정화를 이룰 것입니다.  
이 프로젝트는 블록체인 기술의 본질적 가치를 반영하며, 창의적이고 독창적인 방식으로 새로운 가능성을 탐구합니다. UBMS는 느리지만 꾸준히 성장하며, 사용자와 개발자 모두에게 신뢰를 제공할 것을 약속합니다.

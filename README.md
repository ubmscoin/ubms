...
초기 블록체인의 핵심 아이디어는 변조 불가능한 해시 기술, 채굴, 합의 알고리즘으로 요약되며, 주로 통신 속도 개선에 초점이 맞춰졌습니다. 하지만 블록체인의 근본적인 구조적 특성 때문에 체결 및 통신 속도가 기술 발전의 발목을 잡고 있는 실정입니다.  
군계일학으로 이더리움의 EVM 기술은 원장을 유지하기 위해 필요한 막대한 컴퓨팅 자원을 가상 컴퓨팅으로 활용한다는 점에서 기존의 아이디어 중 가장 혁신적인 접근 방식으로 평가받고 있습니다.  

블록체인은 엄청난 시장 파급 효과를 보여주었지만 ,동시대에 등장한 AI 산업과 비교해 보면, 블록체인의 기술 응용 범위는 상당히 제한적입니다.

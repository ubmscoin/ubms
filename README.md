...
### **4.3. UBMS 독자적 방식 주요 단계**
#### 이더리움과 UBMS 네트워크 구조를 비교하면 비콘체인이 없고 구조적,절차적으로 단순하고 가볍습니다. 비트코인은 네트워크 구조가 달라 수평비교가 안되어 이하 도표에서 생략합니다.
...
UBMS 방식에서는 한 번에 5개의 lookup 결과를 활용하여 gossip 메시지를 전파하고, TTL 5 내에서 빠른 동기화를 이루는 것이 목표입니다.  

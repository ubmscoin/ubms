...
세계 각국은 연구 및 개발에 막대한 자금을 투입하나, 기술 발전 속도는 여전히 도전 과제로 남아 있습니다.
...
외부에서 수신한 1ubms의 시장가를 바탕으로 기저 수수료가 결정됩니다.  
초기 액면가 기준으로 1ubms당 시장가가 **10,000원**이면 기저 수수료는 **1,000원**으로,  
시장이 고평가되어 1ubms당 시장가가 **100,000,000원**에 달할 경우 기저 수수료는 **100,000원**으로 설정됩니다.  
경제팩터는 외부에서 상수값으로 받아오므로, 본 계산에서는 경제팩터와 네트워크 혼잡팩터를 모두 반영하여 최종 수수료를 산출합니다.

# $$F = B \times EF \times CF \quad = \quad 1000 \times \sqrt{\frac{v}{10\,000}} \times CF$$

여기서,  
- $$F$$는 최종 수수료 (원 단위)입니다.  
- $$v$$는 1ubms의 시장가 (원 단위)입니다.  
- $$B$$는 외부에서 결정된 기저 수수료로,  
  - 1ubms당 시장가가 10,000원일 경우 $$B = 1000 \, \text{원}$$,  
  - 1ubms당 시장가가 100,000,000원일 경우 $$B = 100\,000 \, \text{원}$$입니다.  
- $$EF$$는 경제팩터로, 시장가에 따라 기저 수수료를 보정하는 역할을 합니다.  
- $$CF$$는 네트워크 혼잡팩터로, 최근 250개 블록의 혼잡도를 반영하여 조정됩니다.

##### 예시 1:
- 외부 기저 수수료: $$B = 1000 \, \text{원}$$  
- 시장가: $$v = 10\,000 \, \text{원}$$  
- 경제팩터:  
  ## $$EF = \sqrt{\frac{10\,000}{10\,000}} = 1$$  
- 네트워크 혼잡팩터: $$CF = 1.0$$  

## $$F = 1000 \times 1 \times 1.0 = 1000 \, \text{원}$$

##### 예시 2:
- 외부 기저 수수료: $$B = 100\,000 \, \text{원}$$  
- 시장가: $$v = 100\,000\,000 \, \text{원}$$  
- 경제팩터:  
  ## $$EF = \sqrt{\frac{100\,000\,000}{10\,000}} = \sqrt{10\,000} = 100$$  
- 네트워크 혼잡팩터: $$CF = 1.0$$  

## $$F = 100\,000 \times 100 \times 1.0 = 100\,000 \, \text{원}$$
